...
export default function HomePage() {
  ...
  // Summary stats — only from sent campaigns
      ...
      {!loading && summaryStats && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
          ...
          <div className="stat-card">
            ...
            <div className="text-2xl font-medium tabular-nums">
              {summaryStats.totalOpens.toLocaleString()}
            </div>
          </div>
          <div className="stat-card">
            <div className="text-2xs font-medium uppercase tracking-wider text-gallery-mid mb-1">
          ...
          <div className="stat-card">
            ...
            <div className="text-lg font-medium truncate" title={summaryStats.bestName}>
              {summaryStats.bestRate}%
            </div>
            <div className="text-2xs text-gallery-mid truncate mt-0.5" title={summaryStats.bestName}>
              {summaryStats.bestName}
            </div>
          </div>
        </div>
      )}
        ...
        <div className="border border-gallery-border bg-gallery-white">
          ...
          {sorted.map((c) => (
            ...
            >
              ...
              {/* Stats — shown as row on mobile, columns on desktop */}
