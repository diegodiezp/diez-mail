...
export async function listThreads({ query = '', pageToken, maxResults = 25, label = 'INBOX' } = {}) {
  ...
  const parts = [];
  // Catch all emails involving diego@diez.gallery in any field
  parts.push('{from:diego@diez.gallery to:diego@diez.gallery cc:diego@diez.gallery bcc:diego@diez.gallery}');
