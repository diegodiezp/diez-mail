...
// Campaign detail: the campaign record plus per-recipient send/open/click
// stats, built from its events. Shared by the campaign detail API and the
// per-campaign CSV export so both report the exact same numbers.
