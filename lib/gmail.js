...
export function wrapLinksWithTracking(html, trackingId, campaignId, recipientEmail) {
  ...
  return html.replace(
    ...
    (match, url) => {
      ...
      const trackedUrl = buildTrackedLink(trackingId, campaignId, recipientEmail, url);
...
<body style="font-family: Georgia, 'EB Garamond', serif; font-size: 15px; line-height: 1.6; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 20px;">
${html}
${pixel}
</body>
</html>`;
